...
const DreamJobFrontComponent = ({ data }) => {
    ...
    const content = useMemo(() => {
        if (remoteFrequency === REMOTE_FREQUENCY.FULL_TIME) {
            return (
                <>
                    <ProfileCardFrontVector customClasses={{ container: classes.logo }} vector={EmailLogo} />
        ...
        return (
            <>
                ...
                <ProfileCardFrontTypography classes={{ container: classes.typography }}>
                    <FormattedMessage
                        id="Reachout.Front.title"
                        defaultMessage="Reach out for a chat"
                    />
                </ProfileCardFrontTypography>
            </>
        );
        ...
        <>
            ...
            <ProfileCardActions>
                <ProfileCardButton onClick={handleButtonClick}>
                    <FormattedMessage id="Reachout.front.action" defaultMessage="View all channels" />
                </ProfileCardButton>
            </ProfileCardActions>
        </>
    );
